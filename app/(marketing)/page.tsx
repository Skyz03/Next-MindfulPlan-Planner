...
import { ArrowRight, Layout, Target, Zap, Calendar, Clock, BarChart3 } from 'lucide-react'

export default function LandingPage() {
    return (
        <div className="min-h-screen bg-[#FAFAF9] dark:bg-[#0C0A09] text-stone-900 dark:text-stone-200 selection:bg-orange-500/30">

            {/* 1. NAVBAR (Unchanged, just ensures it's fixed) */}
            <nav className="fixed top-0 w-full z-50 border-b border-stone-200/50 dark:border-white/5 bg-[#FAFAF9]/90 dark:bg-[#0C0A09]/90 backdrop-blur-xl">
                <div className="max-w-7xl mx-auto px-8 h-20 flex items-center justify-between">
                    <div className="flex items-center gap-3 font-serif font-bold text-xl tracking-tight">
                        <div className="w-9 h-9 bg-orange-500 rounded-xl flex items-center justify-center text-white shadow-sm">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3"><path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5"></path></svg>
                        </div>
                        Architect
                    </div>
                    <div className="flex items-center gap-8 text-sm font-medium">
                        ...
                        <Link href="/dashboard" className="bg-stone-900 dark:bg-white text-white dark:text-black px-5 py-2.5 rounded-xl hover:opacity-90 transition-opacity shadow-sm">
                            Enter Studio
                        </Link>
                    </div>
                </div>
            ...
            {/* 2. HERO SECTION (More padding, bigger text) */}
            <section className="relative pt-40 pb-32 md:pt-56 md:pb-48 px-8 overflow-hidden">
                <div className="max-w-5xl mx-auto text-center space-y-10 relative z-10">
                    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-orange-50 dark:bg-orange-900/20 border border-orange-100 dark:border-orange-900/50 text-orange-600 dark:text-orange-400 text-xs font-bold uppercase tracking-widest shadow-sm">
                    ...
                    <h1 className="text-6xl md:text-8xl font-serif font-bold tracking-tight leading-[1.05]">
                        Design your time. <br />
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-5 pt-8">
                        <Link href="/dashboard" className="h-14 px-10 rounded-2xl bg-stone-900 dark:bg-white text-white dark:text-black font-bold flex items-center gap-3 hover:scale-105 transition-transform shadow-lg shadow-stone-900/10 dark:shadow-none text-lg">
                            Start Building
                ...
                {/* Background Elements (More subtle and spread out) */}
                <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-full max-w-7xl pointer-events-none opacity-30 dark:opacity-20">
                    <div className="absolute top-1/4 -left-20 w-[500px] h-[500px] bg-orange-200/40 rounded-full blur-3xl mix-blend-multiply filter"></div>
                    <div className="absolute bottom-1/4 -right-20 w-[600px] h-[600px] bg-amber-100/40 dark:bg-purple-900/20 rounded-full blur-3xl mix-blend-multiply filter"></div>
                </div>
            </section>


            {/* =====================================================================================
          FEATURE 1: WEEKLY PLANNER (The Strategy)
      ===================================================================================== */}
            <section className="py-32 px-8 bg-white dark:bg-[#141416]">
                <div className="max-w-7xl mx-auto">
                    <div className="flex flex-col md:flex-row items-center gap-16 md:gap-24">

                        {/* Text Side */}
                        <div className="flex-1 space-y-8">
                            <div className="w-14 h-14 bg-stone-100 dark:bg-stone-800 rounded-2xl flex items-center justify-center text-stone-900 dark:text-stone-100">
                        ...
                        <div className="flex-1 relative group">
                            ...
                            <div className="relative bg-stone-50 dark:bg-[#1C1917] border border-stone-200 dark:border-stone-800 rounded-[2.5rem] p-3 shadow-2xl shadow-stone-200/50 dark:shadow-none overflow-hidden">
            ...
            {/* =====================================================================================
          FEATURE 2: FOCUS MODE (The Execution)
      ===================================================================================== */}
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="flex flex-col-reverse md:flex-row items-center gap-16 md:gap-24">
                        ...
                        <div className="flex-1 relative group">
                            ...
                            <div className="relative bg-white dark:bg-[#18181b] border border-stone-200 dark:border-stone-800 rounded-[2.5rem] p-8 shadow-2xl shadow-stone-200/50 dark:shadow-none flex flex-col items-center text-center">
                                <div className="w-24 h-24 rounded-full bg-orange-50 dark:bg-orange-900/20 flex items-center justify-center mb-8 relative">
                                    <div className="absolute inset-0 rounded-full border-4 border-orange-500 border-t-transparent animate-spin"></div>
                                    <span className="font-serif text-3xl font-bold text-orange-600 dark:text-orange-400">25:00</span>
                                </div>
                                <h3 className="text-2xl font-serif font-bold mb-2">Deep Work Session</h3>
            ...
            {/* =====================================================================================
          FEATURE 3: REFLECTION & AI (The Insight)
      ===================================================================================== */}
            <section className="py-32 px-8 bg-[#1C1917] text-white relative overflow-hidden">
                {/* Background Accents */}
                <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
                    <div className="absolute top-1/4 right-1/4 w-[800px] h-[800px] bg-orange-500/10 rounded-full blur-[120px] mix-blend-screen"></div>
                </div>
                ...
                <div className="max-w-7xl mx-auto relative z-10">
                    <div className="flex flex-col md:flex-row items-center gap-16 md:gap-24">
                        ...
                        {/* Text Side */}
                        <div className="flex-1 space-y-8">
                            <div className="w-14 h-14 bg-white/10 rounded-2xl flex items-center justify-center text-orange-400">
                            ...
                            <div className="flex gap-4 pt-4">
                                <div className="px-4 py-2 rounded-full bg-white/10 border border-white/10 text-sm font-medium flex items-center gap-2">
                        ...
                        <div className="flex-1 relative">
                            <div className="grid grid-cols-2 gap-4">
                                {/* AI Card */}
                                <div className="col-span-2 bg-gradient-to-br from-stone-800 to-stone-900 border border-white/10 rounded-3xl p-8 relative overflow-hidden shadow-2xl">
                                    <div className="absolute top-0 right-0 p-32 bg-orange-500/20 rounded-full blur-3xl -mr-20 -mt-20 pointer-events-none"></div>
                                    <h3 className="text-lg font-bold font-serif mb-4 flex items-center gap-2 relative z-10">
                                ...
                                {/* Sankey/Flow Card */}
                                <div className="bg-stone-800/50 border border-white/10 rounded-3xl p-6 h-48 relative overflow-hidden group hover:border-orange-500/50 transition-colors">
                                    ...
                                    <div className="absolute bottom-6 left-6">
                                        ...
                                        <div className="font-serif text-xl font-bold">High Intent</div>
                                    </div>
                                </div>

                                {/* Score Card */}
                                <div className="bg-white text-stone-900 rounded-3xl p-6 h-48 flex flex-col justify-center items-center text-center relative overflow-hidden">
            ...
            <section className="py-40 px-8 text-center relative overflow-hidden">
                <div className="max-w-3xl mx-auto relative z-10 space-y-8">
                    ...
                    <div className="pt-8">
                        <Link href="/dashboard" className="inline-flex h-16 px-12 rounded-2xl bg-orange-500 text-white font-bold items-center gap-3 hover:bg-orange-600 transition-colors shadow-xl shadow-orange-500/20 text-xl">
                            Enter the Studio
            ...
            {/* 6. FOOTER */}
            <footer className="border-t border-stone-200 dark:border-stone-800 py-16 px-8 bg-white dark:bg-[#0C0A09]">
