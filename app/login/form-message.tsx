...
export function FormMessage() {
    ...
    return (
        <div className={`
      relative overflow-hidden rounded-xl border p-4 shadow-lg backdrop-blur-md
    ...
    `}>
            ...
            <div className={`absolute bottom-0 left-0 h-0.5 w-full bg-current opacity-20`}>
                <div className="h-full bg-current w-full animate-[shrink_6s_linear_forwards] origin-left"></div>
            </div>
        </div>
    )
}