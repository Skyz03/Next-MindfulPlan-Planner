  ...
  return (
    <div className="group relative flex items-center gap-4 p-5 bg-white/40 hover:bg-white rounded-2xl border border-white/60 hover:border-indigo-100 shadow-sm hover:shadow-md transition-all duration-300">
      ...
      <div className="flex-1">
        ...
        {/* Goal Badge */}
        {task.goals && (
          <span className="inline-block mt-1 px-2 py-0.5 bg-indigo-50 text-indigo-600 text-[10px] font-bold uppercase tracking-wider rounded-full border border-indigo-100">
            {task.goals.title}
          </span>
        )}
      </div>
