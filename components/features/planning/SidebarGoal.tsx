...
export default function SidebarGoal({ goal }: { goal: any }) {
  ...
  return (
    // ✅ RESPONSIVE: pl-2 is fine, but parent container handles horizontal constraints
    <div className="group/goal relative w-full pl-2">
      ...
      <div className="relative mb-2 flex items-start gap-3">
        {/* Toggle Button: Good touch target (6x6 = 24px) */}
        <button
        ...
        <div className="min-w-0 flex-1 py-1">
          <div className="group/title flex items-center justify-between gap-2">
            ...
            {/* Hover Actions: On mobile, hover doesn't exist. 
               Ideally, we show these on tap or make them always visible but low opacity.
               For simplicity here, we rely on opacity transition or make them visible if expanded.
            */}
      ...
      {isExpanded && (
        <div className="animate-in slide-in-from-top-2 fade-in relative space-y-2 pr-1 pb-4 pl-9 duration-200">
          ...
          {/* Add Step Form: Stack inputs slightly better on mobile */}
          <form
            action={addTask}
          ...
          >
            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              {/* ✅ RESPONSIVE: Use flex-1 to take available space */}
              <input
                name="title"
              ...
              {/* Extras Container: Show on focus/hover */}
              <div className="flex items-center gap-2 opacity-0 transition-opacity group-hover/add:opacity-100 focus-within:opacity-100">
                ...
                <select
                  name="priority"
                  defaultValue="medium"
                  className="rounded border border-stone-200 bg-transparent px-1.5 py-1 text-[10px] text-stone-500 outline-none md:py-0.5 dark:border-stone-700 dark:text-stone-400"
                >
